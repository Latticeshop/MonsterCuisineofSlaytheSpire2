...
/// <summary>石头（特殊料理）：自己失去10点生命。掉落自旧日雕像。</summary>
public sealed class Stone : FoodCardModel
{
    private static readonly FoodCardValues.CardValues Values = FoodCardValues.Stone;

    public override FoodStats FoodStats => FoodStats.Special;

    public Stone() : base(CardType.Skill, CardRarity.Token, TargetType.Self) { }
