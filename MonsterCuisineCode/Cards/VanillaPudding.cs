...
/// <summary>香草布丁（由香草果冻煮成）：回复5点生命，抽2张牌，消耗。</summary>
public sealed class VanillaPudding : FoodCardModel
{
    private static readonly FoodCardValues.CardValues Values = FoodCardValues.VanillaPudding;

    public override FoodStats FoodStats => FoodStats.Of(viscosity: 1m, plant: 0.5m);

    public VanillaPudding() : base(CardType.Skill, CardRarity.Token, TargetType.Self) { }
